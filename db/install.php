...
/**
 * Installation code for the academic ticket system.
 *
 ...
 */
function xmldb_local_academic_ticket_system_install() {
    global $DB;
    ...
    $DB->insert_record('local_academic_ticket_system_categories', $category);
}
